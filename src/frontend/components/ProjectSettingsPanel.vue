    ...
    <div v-else class="space-y-6">
      <div>
        ...
        <div class="space-y-4">
          <!-- Endpoint URL -->
          <div>
            <label class="block text-xs font-medium text-gray-600 mb-1"> MinIO Endpoint URL </label>
            <input
              v-model="endpointUrl"
              type="text"
          ...
          <!-- Access Key -->
          <div>
            <label class="block text-xs font-medium text-gray-600 mb-1"> Access Key </label>
            <input
              v-model="accessKeyId"
              type="text"
          ...
          <div class="flex items-center gap-2">
            ...
            />
            <label for="use-ssl" class="text-xs font-medium text-gray-600"> Use SSL/TLS </label>
          </div>
        </div>
      </div>
      ...
      <div class="bg-blue-50 border border-blue-200 rounded-md p-3">
        <p class="text-xs text-blue-800">
          <strong>Note:</strong> Credentials are encrypted and stored securely. They will be used to sync images and
          annotations with your MinIO storage.
        </p>
      </div>
    </div>
  </div>
