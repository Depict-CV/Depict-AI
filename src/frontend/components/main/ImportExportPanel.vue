        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            >
              ...
              <label for="file-upload" class="cursor-pointer">
                ...
                <p class="text-sm text-gray-600 mb-1">
                  <span class="text-blue-600 font-medium">Click to select folder</span>
                  with images
                </p>
            ...
            >
              ...
              <button @click="importFile = null" class="text-red-600 hover:text-red-700 text-sm font-medium">
                Remove
              </button>
            </div>
          </div>
          ...
          <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <p class="text-sm text-yellow-800">
              <strong>Note:</strong> Importing will add data to your existing project. Duplicate entries will be
              skipped.
            </p>
          </div>
