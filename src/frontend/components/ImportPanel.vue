  ...
  <div>
    ...
    <div class="space-y-6">
      ...
      <div>
        ...
        <div class="space-y-2">
          <!-- Local Directory -->
          <label class="flex items-center gap-3 p-3 border-2 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors"
      ...
      <div v-if="importMethod === 'minio'" class="space-y-4">
        ...
        <div class="bg-amber-50 border border-amber-200 rounded-lg p-4">
          <p class="text-sm text-amber-800">
            <strong>Prerequisites:</strong> MinIO credentials must be configured in <strong>Project Settings</strong> before syncing.
          </p>
        </div>
        
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <p class="text-sm text-blue-800">
            This will sync all images from the configured MinIO bucket to your project. Images already in the database will be skipped.
          </p>
        </div>
