<script setup>
import { ref } from 'vue';
import { Settings, X, Globe, Bell, Palette, Lock, Database } from 'lucide-vue-next';
  ...
  <div v-if="show" class="settings-overlay" @click="closeModal">
    <div class="settings-modal" @click.stop>
      <div class="settings-header">
        ...
        <button class="settings-close" @click="closeModal">
          <X :size="20" />
        </button>
      </div>
      ...
      <div class="settings-footer">
        <button class="settings-btn cancel" @click="closeModal">Cancel</button>
